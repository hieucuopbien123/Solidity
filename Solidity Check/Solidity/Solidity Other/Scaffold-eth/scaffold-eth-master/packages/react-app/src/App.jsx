      ...
      <Switch>
        ...
        <Route exact path="/debug">
          ...
          <Button onClick={async () =>{
            const tokenAddress = "0xe7f1725E7734CE288F8367e1Bb143E90bb3F0512";//address contract sau deploy
            ...
            console.log(result);
            // console.log("http://" + (global.window ? window.location.hostname : "localhost") + ":8545");
          }}>
            Permit
          </Button>
          <Contract
            name="MyFirstTokenInLife"
            price={price}
            signer={userSigner}
