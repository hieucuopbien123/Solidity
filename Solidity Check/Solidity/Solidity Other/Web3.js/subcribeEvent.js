...
//Ta phải dùng WebsocketProvider mới đc. Khi dùng như v thì url phải có scheme là wss or ws tùy TH
//bth ta chạy 1 lần thỉ k cần provider, nhưng subscribe tức là nó luôn luôn bắt event khi nào có thì báo. Khi đó
//cần dùng 1 providers để liên kết liên tục với ethe blockchain và app phải trong TT bật liên tục
async function main() {
