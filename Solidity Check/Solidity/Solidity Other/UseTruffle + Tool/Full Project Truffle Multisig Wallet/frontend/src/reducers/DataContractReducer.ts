import { SET, UPDATECONFIRM, UPDATEREVOKE, UPDATEEXECUTE, UPDATESUBMIT,
    Set, UpdateConfirm, UpdateRevoke, UpdateExecute, UpdateSubmit,
    Data } from "../actions/index";
...
// interface Action extends State{//dùng như này chứ dùng toán tử OR | nó éo chạy
            ...
            const transactions = [
                {
                    ...
                    to: data.to,
                    value: data.value,
                    //trong file tsx k dùng parseInt mà chỉ được trong file ts. File này chứa component của react
                    //dùng được các thư viện của NodeJs nên phải dùng Web3.utils.toBN
                    //Còn toNumber là hàm của type string
                    executed: false,
                    data: data.data,
                    numComfirmation: 0,
