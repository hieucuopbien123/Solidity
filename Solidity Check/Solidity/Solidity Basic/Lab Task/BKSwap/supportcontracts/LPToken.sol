...
contract LPToken is ILPToken{
    ...
    //lúc gọi hàm này thì địa chỉ hợp lệ r và chỉ cần gửi thôi
    ...
    //sự khác biệt khi kế thừa và dùng interface. Kế thừa là dùng trực tiếp hàm của nó. còn dùng interface là gọi theo kiểu tương tác với 1 
    //contract khác. VD: kế thừa ta gọi 1 hàm của chính nó thì msg.sender kp là chính nó mà là ng gọi hàm gọi nó-> chú ý msg.sender 1 cái 
    //là contract, 1 cái là ng gọi khác nhau
