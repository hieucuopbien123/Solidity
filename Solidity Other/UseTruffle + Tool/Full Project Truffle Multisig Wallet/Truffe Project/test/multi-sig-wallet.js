...
//chỉ dùng đúng 2 thư viện này viết test
...
contract("MultisignatureWallet", accounts => {
    ...
    describe("executeTransaction", () => {
        //có code trùng ta nhét vào beforeEach, nhưng ta chỉ muốn phần code này thực hiện với riêng 2 test này mà
        //thôi nên ta nhét vào 1 describe
        beforeEach(async() => {
            await wallet.submitTransaction(owners[0], 0, "0x00");//specific người thực hiện transaction(msg.sender)
            //mặc định là owners[0]
        ...
        it("should execute", async() => {
            ...
            const {logs} = res;
            //khi lấy giá trị trả về của 1 transaction sau khi gọi thì nó chứa toàn bộ những thứ cần thiết của 
            //function đó như event chẳng hạn, các thứ hiện ra như ỏ console của remix, logs là chuyên chứa event
            console.log("Res: ", res);
        ...
        it("should reject if already executed", async() => {
            ...
            // }
            //hàm bên trên của mocha cồng kềnh ở chỗ, ta muốn 1 hàm fail thì phải check nó fail thì bắt đúng lỗi là
            //ok nhưng check nó đúng thì throw 1 cái error khác. chai-as-promised cho ta cách test ngắn gọn như dưới
