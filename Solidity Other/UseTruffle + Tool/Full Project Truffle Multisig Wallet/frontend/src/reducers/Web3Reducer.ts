...
type Action = UpdateAccount;//định nghĩa kiểu
//Chú ý định nghĩa interface như 1 struct trong C++ v, là 1 tập hợp các biến có kiểu dữ liệu xác định gộp thành 1
//kiểu dữ liệu mới ta tạo ra mà thôi. Dòng type này như kiểu đặt typedef tức cho 1 cái tên khác thôi
